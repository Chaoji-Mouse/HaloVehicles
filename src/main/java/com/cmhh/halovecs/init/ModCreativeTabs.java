...
public class ModCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> HALOVECS_TAB = 
        TABS.register("halovecs_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((params, output) -> {
                ...
                addM274ContainerToCreativeTab(output);
            })
            .build());
    ...
    private static void addM274ContainerToCreativeTab(CreativeModeTab.Output output) {
        try {
            ItemStack m274Container = createM274Container();
            if (!m274Container.isEmpty()) {
                output.accept(m274Container);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static ItemStack createM274Container() {
        try {
            // 获取container物品
            var containerItem = net.minecraft.core.registries.BuiltInRegistries.ITEM
                .get(ResourceLocation.fromNamespaceAndPath("superbwarfare", "container"));
            ...
            // 设置EntityType
            tag.putString("EntityType", "halovecs:m274");
