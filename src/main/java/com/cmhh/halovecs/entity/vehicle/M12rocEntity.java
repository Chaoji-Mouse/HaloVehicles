...
public class M12rocEntity extends GeoVehicleEntity {
    ...
    public static final EntityDataAccessor<Integer> TEXTURE_VARIANT = SynchedEntityData.defineId(M12rocEntity.class, EntityDataSerializers.INT);
    ...
    private PlayState maingunFirePredicate(AnimationState<M12rocEntity> event) {
