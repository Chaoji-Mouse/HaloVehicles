...
public class M12gauEntity extends GeoVehicleEntity {
    ...
    public static final EntityDataAccessor<Integer> TEXTURE_VARIANT = SynchedEntityData.defineId(M12gauEntity.class, EntityDataSerializers.INT);

    public M12gauEntity(EntityType<M12gauEntity> type, Level world) {
        super(type, world);
    }
    ...
    private PlayState maingunFirePredicate(AnimationState<M12gauEntity> event) {
