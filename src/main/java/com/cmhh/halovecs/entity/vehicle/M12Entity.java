...
public class M12Entity extends GeoVehicleEntity {
    ...
    public static final EntityDataAccessor<Integer> TEXTURE_VARIANT = SynchedEntityData.defineId(M12Entity.class, EntityDataSerializers.INT);
    ...
    private PlayState maingunFirePredicate(AnimationState<M12Entity> event) {
